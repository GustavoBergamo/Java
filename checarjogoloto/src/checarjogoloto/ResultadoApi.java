...
public class ResultadoApi {
    ...
    public static void ResultadoApi() throws MalformedURLException, UnsupportedEncodingException, IOException {
        System.out.print("Digite o concurso: ");
       Scanner a = new Scanner(System.in);
         String concurso = a.next();
    URL url = null;
